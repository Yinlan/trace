...
namespace Trace
{
    public partial class FormConfig : Form
    {
        ...
        {
            string sql = "select SORT as 序号, NAME as 基地名称, PIC as 负责人, ID as 编号 " +
        ...
        {
            string id = dgvSource.SelectedRows[0].Cells[3].Value.ToString();
        ...
        private void btnEditSource_Click(object sender, EventArgs e)
        {
            ...
            source.id = int.Parse(dgvSource.SelectedRows[0].Cells[3].Value.ToString());
            source.name = dgvSource.SelectedRows[0].Cells[1].Value.ToString();
            source.pic = dgvSource.SelectedRows[0].Cells[2].Value.ToString();
